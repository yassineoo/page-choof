export default {
  fr: {
    ...
    "200 DA": {
      confirm: "Appels illimités vers Ooredoo, valables jusqu'à l'expiration de votre forfait 200 DA en cours.",
      success: "Boost activé avec succès, valable jusqu'à l'expiration de votre forfait 200 DA en cours.",
      insufficient: "Votre crédit est insuffisant. Veuillez recharger votre compte.",
    },
    "300 DA": {
      confirm: "600 DA Bonus valables en appels et SMS vers tous les réseaux nationaux, valable jusqu'à l'expiration de votre forfait 300 DA en cours.",
      success: "Boost activé avec succès, valable jusqu'à l'expiration de votre forfait 300 DA en cours.",
      insufficient: "Votre crédit est insuffisant. Veuillez recharger votre compte.",
    },
    "1000 DA": {
      confirm: "Appels illimités vers tous les réseaux nationaux, valables jusqu'à l'expiration de votre forfait 1000 DA en cours.",
      success: "Boost activé avec succès, valable jusqu'à l'expiration de votre forfait 1000 DA en cours.",
      insufficient: "Votre crédit est insuffisant. Veuillez recharger votre compte.",
    },
  },
  ...
  ar: {
    ...
    "200 دج": {
      confirm: "مكالمات غير محدودة نحو Ooredoo، صالحة إلى غاية نهاية صلاحية اشتراكك 200 دج الحالي",
      success: "تمّ تفعيل Boost بنجاح، وهو صالح  إلى غاية نهاية صلاحية اشتراكك 200 دج الحالي.",
      insufficient: "رصيدك غير كافٍ. يرجى تعبئة حسابك.",
    },
    "300 دج": {
      confirm: "600 دج رصيد مُهدى، صالح إلى غاية نهاية صلاحية اشتراكك 300 دج الحالي",
      success: "تمّ تفعيل Boost بنجاح، وهو صالح  إلى غاية نهاية صلاحية اشتراكك 300 دج الحالي.",
      insufficient: "رصيدك غير كافٍ. يرجى تعبئة حسابك.",
    },
    "1000 دج": {
      confirm: "1000 دج مكالمات غير محدودة نحو كل الشبكات، صالحة إلى غاية نهاية صلاحية اشتراكك 1000 دج الحالي",
      success: "تمّ تفعيل Boost بنجاح، وهو صالح  إلى غاية نهاية صلاحية اشتراكك 1000 دج الحالي.",
      insufficient: "رصيدك غير كافٍ. يرجى تعبئة حسابك.",
    },
  },
};
