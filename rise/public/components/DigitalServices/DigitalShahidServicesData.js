  ...
  fr: [
    {
      ...
      name: "SHAHID 500",
      data: "02",
      features: ["Accès shahid mobile", "2Go internet"],
      price: "500",
      duration: "30 jours",
    },
    {
      ...
      name: "SHAHID 1000",
      data: "06",
      features: ["Accès shahid mobile", "6Go internet"],
      price: "1000",
      duration: "30 jours",
    },
  ],
  ar: [
    {
      ...
      data: "02",
      features: ["دخول الى التطبيق شاهد", "<span class='font-rubik'>2Go</span> إنترنت"],
      price: "500",
      duration: "30 يوم",
    },
    {
      ...
      data: "06",
      features: ["دخول الى التطبيق شاهد", "<span class='font-rubik'>6Go</span> إنترنت"],
      price: "1000",
      duration: "30 يوم",
    },
  ],
...
export const shahidModalData = {
  ...
  ar: {
    "شاهد <span class='font-rubik'>500</span>": {
      ...
      insufficient: "عزيزي الزبون، رصيدك غير كافٍٍ لشراء الإشتراك شاهد 500 يُرجى تعبئة حسابك والمحاولة مرة أخرى.",
    },
