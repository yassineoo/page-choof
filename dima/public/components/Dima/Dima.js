...
const styles = {
  ...
  nouveauBadge:
    "absolute top-0 left-0 w-[116px] h-[40px] rotate-[45deg] origin-top-left opacity-100 z-10 bg-[#FFD700] rounded-[1.47px] flex items-center justify-center transform translate-x-[20px] translate-y-[20px]",
