export const migrationData = {
  ...
  ar: {
    ...
    migrationNyoozModal: {
      ...
      successTitle: "هنيئًا!",
      successMessage:
        "مرحبًا بك في عرض <span class='font-rubik'>N’YOOZ</span> سارع لتحميل التطبيق My Ooredoo مجانًا لشراء أو تشكيل الاشتراك الذي يناسبك واستمتع بمغامرة<br> <span class='font-rubik'>N’YOOZ! <a href='http://ore.do/yo' class='underline text-blue-600'>http://ore.do/yo</a> </span> <br/> قم بشراء اشتراكاتك على #151*",
    },
  },
};
