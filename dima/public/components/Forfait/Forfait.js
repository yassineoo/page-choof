  ...
  getDefaultModalContent(offer, language) {
    ...
    return {
      ...
      insufficient: isArabic
        ? `رصيدك غير كافٍ. يُرجى إعادة تعبئة حسابك.`
      ...
      <div class="fixed inset-0 z-[9999] flex items-center justify-center p-4 forfait-modal-fade"
        ...
        <img src="./assets/images/Close.svg" alt="close"/>
              ...
              <div class="text-center mb-6">
                  <h2 id="modal-title" class="font-semibold text-ooredoo-red dark:text-white text-2xl md:text-3xl leading-tight uppercase tracking-tight">
                      ${title}
                  </h2>
              </div>
