export class ModalSlider {
  ...
  createCardHTML(offer) {
    ...
    return `
      <div class="flex w-full flex-shrink-0 flex-col items-center gap-[10px] rounded-[20px] border border-[#C5C5C5] bg-white dark:bg-gray-800 dark:border-gray-700 pb-[25px] h-full overflow-hidden" ${dirAttribute}>
        <div class="flex flex-col items-center gap-[22px] self-stretch h-full">
          <div class="flex self-stretch items-center justify-center gap-[10px] py-[13px] px-[20px] border-b border-dashed border-[#CDCDCD] dark:border-gray-700 bg-white dark:bg-gray-800 w-full">
          ...
          <div class="flex flex-col items-center gap-[10px] self-stretch px-[10px] h-full justify-between">
            <div class="self-stretch text-black dark:text-gray-300 text-center font-rubik text-[12px] font-normal leading-[20px] min-h-[60px]">
              ${offer.description}
            </div>
