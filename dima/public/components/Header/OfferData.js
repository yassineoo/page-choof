export const offerData = {
  ...
  text: {
    ...
    ar: {
      ...
      autoModalTitle: "وضع إعادة الشحن",
      autoModalDesc: 'ستقوم بتعديل وضع إعادة الشحن الخاص بك إلى "تلقائي" :',
      autoSuccessTitle: "مبروك!",
      autoSuccessDesc: (price, planName) =>
        `عمليات إعادة الشحن القادمة بقيمة ${price} دج وأكثر ستمنحك مزايا ${planName}، بعد انتهاء صلاحية باقتك.`,
      cancelBtn: "إلغاء",
      confirmBtn: "تأكيد",
      modifyBtn: "تعديل",
      renewalInfoAuto: (name, price) =>
