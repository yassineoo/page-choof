export default {
  fr: {
    "Smart 200": {
      confirm: `INTERNET illimité, valable 24H pour 200 DA seulement.`,
      success: `INTERNET illimité attribué, valable 24H.`,
    ...
    "Forfait 100": {
      ...
      success: `700Mo + YouTube illimité attribués, valables 24H.`,
    ...
    "Forfait 1000": {
      confirm: `15Go + 5Go YouTube valables 30 jours, pour 1000 DA seulement.`,
      success: `15Go + 5Go YouTube attribués, valables 30 jours.`,
      insufficient: `Votre crédit est insuffisant pour acheter le forfait 1000. Veuillez recharger votre compte.`,
    },
    "Forfait 1500": {
      confirm: `40Go + YouTube illimité valables 30 jours, pour 1500 DA seulement.`,
  ...
  ar: {
    "Smart 200": {
      confirm: `إنترنت غير محدودة صالحة لمدة 24 ساعة بـ 200 دج فقط.`,
      success: `لقد حصلت على إنترنت غير محدودة صالحة لمدة 24 ساعة`,
    ...
    "اشتراك 1000": {
      confirm: `5Go + 15Go يوتيوب صالحين إلى غاية نهاية دورة الفوترة الخاصة بك، بـ 1000 دج فقط`,
      success: `لقد حصلت على 5Go + 15Go يوتيوب صالحين مدة 30 يومًا.`,
    ...
    "اشتراك 1500": {
      ...
      success: `لقد حصلت على 40Go + يوتيوب غير محدود، صالحين 30 يومًا.`,
