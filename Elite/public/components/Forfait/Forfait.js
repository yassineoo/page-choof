...
#forfaits-slider-grid.forfait-grid-5 > *:nth-child(1),
#forfaits-slider-grid.forfait-grid-5 > *:nth-child(2),
#forfaits-slider-grid.forfait-grid-5 > *:nth-child(3),
#forfaits-slider-grid.forfait-grid-5 > *:nth-child(4),
#forfaits-slider-grid.forfait-grid-5 > *:nth-child(5),
#calls-slider-grid.forfait-grid-5 > *:nth-child(1),
#calls-slider-grid.forfait-grid-5 > *:nth-child(2),
#calls-slider-grid.forfait-grid-5 > *:nth-child(3),
#calls-slider-grid.forfait-grid-5 > *:nth-child(4),
#calls-slider-grid.forfait-grid-5 > *:nth-child(5) {
  grid-row: auto;
  grid-column: auto;
  justify-self: center;
  margin: 0;
...
<section class="w-full bg-[#141B4D] dark:bg-[#2c2c2c] py-16">
  <div class="max-w-[1600px] mx-auto md:px-6">
    <h2 class="text-3xl sm:text-4xl md:text-5xl font-medium mb-16 leading-tight tracking-wide text-white text-center">
      ${this.createMixedTitleHTML(labels.titleCalls, "uppercase")}
    </h2>
    ${this.slider.createResponsiveLayout(
      data.callForfaits,
      labels,
  ...
  `;
    ...
    requestAnimationFrame(() => {
      ...
      this.slider.initSwiper("calls-slider");
    });
    setTimeout(() => {
      this.initializeSliders();
  ...
  initializeSliders() {
    ...
    this.setupSlider("calls", (data.callForfaits || []).length);
  }
