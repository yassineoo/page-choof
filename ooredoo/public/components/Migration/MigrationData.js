export const migrationData = {
  fr: {
    ...
    migrationNyoozModal: {
      ...
      successTitle: "MIGRATION",
      successMessage:
        "Bienvenue sur N'YOOZ ! Télécharge vite l'application My Ooredoo gratuitement pour acheter ou composer le forfait de ton choix et vis pleinement l'aventure N'YOOZ ! <a href='http://ore.do/yo' class='underline text-blue-600'>http://ore.do/yo</a> <br/> Retrouve tes forfaits sur *151#.",
    },
  },
  ar: {
    title: "التغيير",
    ...
    migrationNyoozModal: {
      ...
      successTitle: "هنيئًا!",
      successMessage:
        "مرحبًا بك في عرض <span class='font-rubik'>N’YOOZ</span> سارع لتحميل التطبيق My Ooredoo مجانًا لشراء أو تشكيل الاشتراك الذي يناسبك واستمتع بمغامرة <br/> <span dir='rtl' class='font-rubik whitespace-nowrap'>N’YOOZ! <a href='http://ore.do/yo' class='underline text-blue-600'>http://ore.do/yo</a></span> <br/> قم بشراء اشتراكاتك على #151*",
    },
  },
};
