...
export const generateHeaderHTML = (
  ...
  const getOfferText = (offer) => {
    if (language === "ar") {
      if (offer === "Offre  Ooredoo POP") return "عرض Ooredoo POP";
  ...
  <div class="bg-ooredoo-red py-4 text-white w-full">
    ...
    userData.phone || "0509876543"
            ...
            <div class="flex items-center gap-2 min-w-0">
              ...
              <span class="hdr-common-text">${language === 'ar' ? "عرض <span dir='ltr' class='font-rubik'>Ooredoo POP</span>" : userData.offer}</span>
            </div>
