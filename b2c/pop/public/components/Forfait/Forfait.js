...
import { modalRamadanData, ramadanSliderData } from "../../../../shared/component/constants.js";
...
@media (min-width: 768px) and (max-width: 991px) {
      ...
      <section class="w-full bg-white dark:bg-[#2c2c2c] pt-16">
        <div class="max-w-[1600px] mx-auto md:px-6">
          <h2 class="text-3xl sm:text-4xl md:text-5xl font-medium mb-16 leading-tight tracking-wide text-center">
            ${this.currentLang === "ar" ? "تغيير الإشتراك الموالي" : "CHANGER LE PROCHAIN FORFAIT"}
          </h2>
        ...
        <div class="relative py-16 dark:bg-black bg-white">
          ...
          <div class="">
              ${this.ramadanSlider.createResponsiveLayout(13,labels, "forfait-grid-4", this.isRTL, this.convertToLatinNumerals)}
          </div>
          ...
          <div class="hidden md:block absolute top-0 left-0 opacity-25">
            <img 
  ...
  `;
    ...
    this.bindPurchaseButtons(language, [...data.forfaits,...data.internetForfaits, ...data.smartForfaits, ...data.ramadanForfaits], labels);
      ...
      <div class="fixed inset-0 z-[9999] flex items-center justify-center p-4 forfait-modal-fade"
          ...
          <div class="relative bg-white dark:bg-[#2C2C2C]  rounded-2xl shadow-2xl w-full max-w-md sm:max-w-lg md:max-w-2xl min-w-[320px] px-6 md:px-8 pt-16 pb-8 md:pb-12" ${dirAttribute}>
              ...
              <div class="text-center mb-6">
                  <h2 id="modal-title" class="${title.includes("Ooredoo POP") || title.includes("Smart") ? "font-rubik" : fontClass} font-semibold text-ooredoo-red dark:text-white text-2xl md:text-3xl leading-tight uppercase tracking-tight">
                      ${title}
                  </h2>
              </div>
