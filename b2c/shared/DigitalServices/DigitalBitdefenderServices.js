...
const bitdefenderTranslations = {
  fr: {
    ...
    congratsMessage: (plan) => `Votre commande a été confirmée. Vous recevrez un SMS avec le lien d’activation.`,
    creditTitle: "Crédit insuffisant",
    creditMessage: (plan) => `Vous n’avez pas assez de crédit pour passer votre commande. Veuillez recharger votre compte et réessayer.`,
    errorTitle: "Erreur",
  ...
  ar: {
    ...
    congratsMessage: (plan) => `لقد تم تأكيد طلبك. ستصلك رسالة قصيرة تتضمن رابط التفعيل.`,
        ...
        <div class="max-w-[95vw] sm:max-w-[90vw] lg:max-w-[90vw] w-full mx-auto bg-white dark:bg-[#2C2C2C] rounded-xl lg:rounded-2xl shadow-lg overflow-hidden dark:border-white border">
          ...
          <div class="rounded-t-xl lg:rounded-t-2xl" style="background-color: #ED1C24;">
            <div class="flex flex-row items-center justify-around md:justify-between p-3 sm:p-4 lg:p-6 gap-3">
              ...
              <div class="flex-1 md:flex-none flex flex-col md:flex-row items-center ${isArabic ? "flex-row-reverse" : ""} gap-2 sm:gap-3 lg:gap-4">
                ...
                <div class="text-white ${isArabic ? "text-right" : "text-left"} text-center sm:text-left">
                  <h2 class="font-medium text-sm sm:text-lg lg:text-[22px] leading-tight">
              ...
              <div class="flex flex-1 flex-col-reverse md:flex-row md:flex-none items-center ${isArabic ? "flex-row-reverse" : ""} gap-2 sm:gap-3 lg:gap-4">
                ...
                <div class="flex-shrink-0">
                  <img src="${this.getIconPath(
                    this.selectedPlan,
                    "iconDark"
                  )}" alt="Device" class="w-28 h-16 sm:w-36 sm:h-20 lg:w-44 lg:h-24 object-contain bitdefender-plan-icon" />
                </div>
              </div>
