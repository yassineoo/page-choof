  ...
  renderMobileLayout(data, theme, lang) {
    ...
    return `
      <div class="w-full flex flex-col ${bgClass} ${fontClass}" ${lang === "ar" ? 'dir="rtl"' : ""}>
        <div class="bg-ooredoo-red w-full px-6 pt-2 pb-14 -my-6"> 
          <h1 class="text-white text-2xl leading-[170%] tracking-[2%] text-center pt-6 pb-4" style="font-weight: 500; font-size: 24px;">
            ${data.title}
          </h1>
        </div>
