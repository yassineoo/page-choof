export default {
  fr: {
    ...
    "Gold 1500": {
      ...
      success: `Vous venez de recevoir 40Go + 3000 DA de crédit vers tous les réseaux nationaux + appels illimités vers Ooredoo, le tout valable 30 jours.`,
    ...
    "Gold 2000": {
      ...
      success: `Vous venez de recevoir 70Go + 6000 DA de crédit vers tous les réseaux nationaux + appels illimités vers Ooredoo, le tout valable 30 jours.`,
    ...
    "Gold 2500": {
      ...
      success: `Vous venez de recevoir 100Go + appels illimités vers tous les réseaux nationaux + SMS illimités vers Ooredoo + 100 SMS vers les autres réseaux nationaux, le tout valable 30 jours.`,
    ...
    "Gold 4000": {
      ...
      success: `Vous venez de recevoir 200Go + appels illimités vers tous les réseaux nationaux + SMS illimités vers Ooredoo + 200 SMS vers les autres réseaux nationaux, le tout valable 30 jours.`,
  ...
  ar: {
    "Gold 1000": {
      confirm: `15Go و2000 دج رصيد نحو كل الشبكات الوطنية + مكالمات غير محدودة نحو Ooredoo، الكل صالح لمدة 30 يوم.`,
      success: `لقد حصلت على 15Go و2000 دج رصيد نحو كل الشبكات الوطنية + مكالمات غير محدودة نحو Ooredoo، الكل صالح لمدة 30 يوم.`,
      insufficient: `رصيدك غير كافٍ لشراء اشتراك GOLD 1000. يُرجى تعبئة حسابك.`,
    },
    "Gold 1500": {
      confirm: `40Go و3000 دج رصيد نحو كل الشبكات الوطنية + مكالمات غير محدودة نحو Ooredoo، الكل صالح لمدة 30 يوم.`,
      success: `لقد حصلت على 40Go و3000 دج رصيد نحو كل الشبكات الوطنية + مكالمات غير محدودة نحو Ooredoo، الكل صالح لمدة 30 يوم. `,
      insufficient: `رصيدك غير كافٍ لشراء اشتراك GOLD 1500. يرجى تعبئة حسابك.`,
    },
    "Gold 2000": {
      confirm:`70Go و6000 دج رصيد نحو كل الشبكات الوطنية + مكالمات غير محدودة نحو Ooredoo، الكل صالح لمدة 30 يوم.`,
      success:`لقد حصلت على 70Go و6000 دج رصيد نحو كل الشبكات الوطنية + مكالمات غير محدودة نحو Ooredoo، الكل صالح لمدة 30 يوم.`,
      insufficient:`رصيدك غير كافٍ لشراء اشتراك GOLD 2000. يرجى تعبئة حسابك.`,
    },
    "Gold 2500": {
      confirm:`100Go ومكالمات غير محدودة نحو كل الشبكات الوطنية + رسائل قصيرة غير محدودة نحو Ooredoo و100 رسالة قصيرة نحو الشبكات الأخرى، الكل صالح لمدة 30 يوم. `,
      success:`لقد حصلت على 100Go + مكالمات غير محدودة نحو كل الشبكات الوطنية + رسائل قصيرة غير محدودة نحو Ooredoo و100 رسالة قصيرة نحو الشبكات الأخرى، الكل صالح لمدة 30 يوم.`,
      insufficient:`رصيدك غير كافٍ لشراء اشتراك GOLD 2500 . يرجى تعبئة حسابك.`,
    },
    "Gold 4000": {
      confirm:`200Go + مكالمات غير محدودة نحو كل الشبكات + رسائل قصيرة غير محدودة نحو Ooredoo و200 رسالة قصيرة نحو الشبكات الأخرى، الكل صالح لمدة 30 يوم.`,
      success:`لقد حصلت على 200Go + مكالمات غير محدودة نحو كل الشبكات + رسائل قصيرة غير محدودة نحو Ooredoo و200 رسالة قصيرة نحو الشبكات الأخرى، الكل صالح لمدة 30 يوم.`,
      insufficient:`رصيدك غير كافٍ لشراء الاشتراك GOLD 4000. يُرجى إعادة تعبئة حسابك.`,
    },
    "اشتراك 1500":{
