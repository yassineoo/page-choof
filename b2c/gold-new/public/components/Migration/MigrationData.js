export const migrationData = {
  fr: {
    ...
    migrationNyoozModal: {
      ...
      successTitle: "MIGRATION",
      successMessage:
        "Bienvenue sur N'YOOZ ! Télécharge vite l'application My Ooredoo gratuitement pour acheter ou composer le forfait de ton choix et vis pleinement l'aventure N'YOOZ ! <a href='https://ore.do/yo' class='underline text-blue-600'>https://ore.do/yo</a> <br/> Retrouve tes forfaits sur *151#.",
    },
  },
  ar: {
    title: "التغيير",
    ...
    cancelBtn: "إلغاء",
    successTitle: "مبروك !",
    change: "هل تريد التغيير إلى عرض <span class='font-rubik whitespace-nowrap'>«La Gold» ؟</span>",
    changeDima: "هل تريد التغيير إلى عرض <span class='font-rubik whitespace-nowrap'> «Dima Ooredoo» ؟</span>",
    changeNyooz: "هل تريد التغيير إلى عرض <span class='font-rubik whitespace-nowrap'>«N’YOOZ » ؟</span>",
    ok: "تم",
    ...
    migrationOoredooModal: {
      ...
      confirmDescription:
        "ستقوم بالتغيير إلى عرض <span class='font-rubik'>La Gold</span> مجانًا وقد يؤدي ذلك إلى خسارة اشتراكك الحالي.",
      successTitle: "هنيئًا!",
      successMessage:
        "أنت الآن مستفيد من عرض <span class='font-rubik'>La Gold</span>. للمزيد من المعلومات، شكّل #500*.",
    },
    migrationNyoozModal: {
