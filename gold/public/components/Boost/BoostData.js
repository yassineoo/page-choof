...
export const boostData = {
  ...
  ar: {
    title: "BOOST 500",
    description: "5 Go إنترنت صالحة حتى نهاية دورة الفوترة الخاصة بك",
    confirmDescription:
    ...
    cancelBtn: "إلغاء",
    successTitle: "مبروك !",
    successMessage: "تمت إضافـة مكالمات غير محدودة نحو كل الشبكات + 50Go + 50 رسالة نصية وطنية، حسب صلاحية باقتك Dima 2000.",
